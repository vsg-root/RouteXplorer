...
vertices = input_reader.ler_arquivo(
    input("Insira o camino do arquivo: ")
)  # ./experiments/input.txt
...
vertices.pop("R")
melhor_caminho, melhor_distancia = melhor_caminho_finder.encontrar_melhor_caminho(
    list(vertices.keys())
)
